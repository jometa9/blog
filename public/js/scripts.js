window.onload = function () {
  ...
  var getCurrentTime = function () {
    ...
    if (current >= 5 && current < 19) return "Buenos días!";
    if (current >= 19 && current < 22) return "Buenas tardes!";
    if (current >= 22 || current < 5) return "Buenas noches!";
  };
  ...
  var sendMessage = function (message, position) {
    var plainText =
      typeof message === "object" && message.type === "image"
        ? "[imagen]"
        : message;
  ...
  var sendMessages = function () {
    ...
    sendMessage(message);
    ++messageIndex;
    var text = typeof message === "string" ? message : "[imagen]";
